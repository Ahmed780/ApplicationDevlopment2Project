...
public class MyAdapter3 extends RecyclerView.Adapter<MyAdapter3.ImageViewHolder> {
    private Context mContext;
    private ArrayList<AdModel> list;
    private OnItemClickListener mListener;

    public MyAdapter3(Context context, ArrayList<AdModel> uploads) {
        mContext = context;
        list = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.view_ad3, parent, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public ImageViewHolder(View itemView) {
            ...
            textViewtitle = itemView.findViewById(R.id.title_text3);
            textViewprice = itemView.findViewById(R.id.price_text3);
            textViewdescription = itemView.findViewById(R.id.description_text3);
            imageviews = itemView.findViewById(R.id.imageUpload3);
            location = itemView.findViewById(R.id.location3);

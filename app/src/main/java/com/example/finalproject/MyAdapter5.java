...
public class MyAdapter5 extends RecyclerView.Adapter<MyAdapter5.ImageViewHolder> {
    private Context mContext;
    private ArrayList<AdModel> list;
    private OnItemClickListener mListener;

    public MyAdapter5(Context context, ArrayList<AdModel> uploads) {
        mContext = context;
        list = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.view_ad5, parent, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public ImageViewHolder(View itemView) {
            ...
            textViewtitle = itemView.findViewById(R.id.title_text5);

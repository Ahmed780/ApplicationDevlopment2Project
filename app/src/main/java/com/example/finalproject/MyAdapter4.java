...
public class MyAdapter4 extends RecyclerView.Adapter<MyAdapter4.ImageViewHolder> {
    private Context mContext;
    private ArrayList<AdModel> list;
    private OnItemClickListener mListener;

    public MyAdapter4(Context context, ArrayList<AdModel> uploads) {
        mContext = context;
        list = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.view_ad4, parent, false);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public ImageViewHolder(View itemView) {
            ...
            textViewtitle = itemView.findViewById(R.id.title_text4);
            textViewprice = itemView.findViewById(R.id.price_text4);
            textViewdescription = itemView.findViewById(R.id.description_text4);
            imageviews = itemView.findViewById(R.id.imageUpload4);

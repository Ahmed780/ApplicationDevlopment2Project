...
public class Category2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selected_category2);
        submitbtn = findViewById(R.id.submit_btn2);
        Inputtitle = findViewById(R.id.EditTitle2);
        Inputprice = findViewById(R.id.editPrice2);
        Inputdescription = findViewById(R.id.editDescription2);
        progressBar = findViewById(R.id.progressBar2);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products2");
        storageReference = FirebaseStorage.getInstance().getReference().child("Ad images2");
        imageView = findViewById(R.id.selectBack2);
        itemPic = findViewById(R.id.itemPic2);
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (task != null && task.isInProgress()) {
                    Toast.makeText(Category2.this, "upload in progress", Toast.LENGTH_SHORT).show();
                }
                ValidateData();
            }
        });
    ...
    StorageReference fileReference = storageReference.child(System.currentTimeMillis() + "." + getFileExtension(Imageuri));
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Category2.this, "got the ad image Url Successfully...", Toast.LENGTH_SHORT).show();
                            postAd();
                        }
                    }
                });
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Category2.this, "Error: " + message, Toast.LENGTH_SHORT).show();
            }
    ...
    private void postAd() {
        ...
        databaseReference.child(uploadId).setValue(adModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(Category2.this, "Ad posted in electronics!", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Category2.this, Categories.class));
                finish();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.categoryMenu:
                Intent intent2 = new Intent(Category2.this, Categories.class);
                this.startActivity(intent2);
                return true;
            case R.id.accountMenu:
                Intent intent3 = new Intent(Category2.this, MyAccount.class);
                this.startActivity(intent3);
                return true;
            case R.id.contactMenu:
                Intent intent4 = new Intent(Category2.this, ContactUs.class);

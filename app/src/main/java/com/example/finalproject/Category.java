...
public class Category  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Inputtitle = findViewById(R.id.contactTitle);
        Inputprice = findViewById(R.id.contactPrice);
        Inputdescription = findViewById(R.id.contactDescription);
        progressBar = findViewById(R.id.progressBar1);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products");
        storageReference = FirebaseStorage.getInstance().getReference().child("Ad images");
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (task != null && task.isInProgress()) {
                    Toast.makeText(Category.this, "upload in progress", Toast.LENGTH_SHORT).show();
                }
                ValidateData();
            }
        });
    ...
    private void ValidateData() {
        ...
        if (Imageuri == null) {
            Toast.makeText(this, "Ad image is mandatory...", Toast.LENGTH_SHORT).show();
        }
    ...
    StorageReference fileReference = storageReference.child(System.currentTimeMillis() + "." + getFileExtension(Imageuri));
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Category.this, "got the ad image Url Successfully...", Toast.LENGTH_SHORT).show();
                            postAd();
                        }
                    }
                });
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Category.this, "Error: " + message, Toast.LENGTH_SHORT).show();
            }
